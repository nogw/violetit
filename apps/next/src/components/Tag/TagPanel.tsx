...
import { TagPanel_community$key } from 'src/__generated__/TagPanel_community.graphql';
import { DeleteTagMutation } from 'src/__generated__/DeleteTagMutation.graphql';
import { DeleteTag } from './mutations/DeleteTagMutation';
import { TagPopup } from './TagPopup';

type TagPanelProps = {
  fragmentKey: TagPanel_community$key;
};
  ...
  return (
    <Card className="w-full flex-col rounded p-2">
      <Box className="ml-auto mb-2">
        <TagPopup callbackTag={handleCreate} communityId={community.id} />
      </Box>
